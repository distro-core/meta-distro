...
-   distro-core
    ...
    ```sh
    # DISTRO=distro-core MACHINE=com-cexpress-bt
    ...
    ```sh
    # DISTRO=distro-core MACHINE=com-cexpress-sl
    ...
    ```sh
    # DISTRO=distro-core MACHINE=sbc-gene-bt05
    ...
    ```sh
    # DISTRO=distro-core-gui MACHINE=sbc-gene-bt05
    ...
    ```sh
    # DISTRO=distro-core MACHINE=sbc-raspberrypi5
    ...
    ```sh
    # DISTRO=distro-core MACHINE=sbc-xavier-nx-devkit
...
-   distro-musl
    ...
    ```sh
    # DISTRO=distro-musl MACHINE=sbc-gene-bt05
...
-   distro-tiny (incomplete)
    ...
    ```sh
    # DISTRO=distro-tiny MACHINE=sbc-gene-bt05
...
-   fetch all
    ```sh
    # DISTRO= MACHINE=
    scripts/images-build --distro="distro-core distro-core-gui distro-musl distro-musl-gui" \
        --machine="com-cexpress-bt com-cexpress-sl sbc-gene-bt05 sbc-raspberrypi5 sbc-xavier-nx-devkit" \
        --target="distro-image distro-sdk-image" --fetch-downloads
    ```
