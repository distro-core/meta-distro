...
# original at https://github.com/kraj/meta-openwrt
...
SRC_URI = "git://git.openwrt.org/project/uqmi.git;protocol=https;branch=master \
...
CFLAGS += "-Wno-error=dangling-pointer -Wno-error=unknown-warning-option"
