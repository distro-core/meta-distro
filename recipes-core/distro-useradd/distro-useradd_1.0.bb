...
USERADD_PARAM:${PN} += "-p '*' -u 1000 -g 1000 -M docker ;"
...
GROUPADD_PARAM:${PN}-admin = "-g 1001 admin"
USERADD_PARAM:${PN}-admin = " \
-p '*' \
-u 1001 -g 1001 -M -d /home/admin ${SHELL_SH} admin"
...
GROUPADD_PARAM:${PN}-user = "-g 1002 user"
USERADD_PARAM:${PN}-user = " \
-p '*' \
-u 1002 -g 1002 -M -d /home/user ${SHELL_RSH} user"
