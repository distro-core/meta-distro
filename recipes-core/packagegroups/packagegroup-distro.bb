...
SUMMARY:${INTERNAL_PG}-gui-core = "Packagegroup for internal organization"
...
SUMMARY:${INTERNAL_PG}-extras = "Packagegroup for internal organization"
...
SUMMARY:${INTERNAL_PG}-docker = "Packagegroup for internal organization"
...
SUMMARY:${INTERNAL_PG}-k3s = "Packagegroup for internal organization"
...
SUMMARY:${INTERNAL_PG}-kubernetes = "Packagegroup for internal organization"
...
SUMMARY:${INTERNAL_PG}-lxc = "Packagegroup for internal organization"
...
SUMMARY:${INTERNAL_PG}-kvm-qemu = "Packagegroup for internal organization"
...
SUMMARY:${INTERNAL_PG}-podman = "Packagegroup for internal organization"
...
SUMMARY:${INTERNAL_PG}-logging = "Packagegroup for internal organization"
...
SUMMARY:${INTERNAL_PG}-logging-libs = "Packagegroup for internal organization"
...
SUMMARY:${INTERNAL_PG}-luks = "Packagegroup for internal organization"
...
SUMMARY:${INTERNAL_PG}-lvm2 = "Packagegroup for internal organization"
...
SUMMARY:${INTERNAL_PG}-connman = "Packagegroup for internal organization"
...
SUMMARY:${INTERNAL_PG}-networkmanager = "Packagegroup for internal organization"
...
SUMMARY:${INTERNAL_PG}-network-core = "Packagegroup for internal organization"
...
SUMMARY:${INTERNAL_PG}-network = "Packagegroup for internal organization"
...
SUMMARY:${INTERNAL_PG}-network-extras = "Packagegroup for internal organization"
...
SUMMARY:${INTERNAL_PG}-ostree = "Packagegroup for internal organization"
...
ostree-switchroot \
"
# RDEPENDS:${INTERNAL_PG}-ostree:remove:wsl-amd64 = "ostree-kernel ostree-initramfs ostree-devicetrees"
# RDEPENDS:${INTERNAL_PG}-ostree:remove:wsl-arm64 = "ostree-kernel ostree-initramfs ostree-devicetrees"

####################

PACKAGES += "${INTERNAL_PG}-test-framework"
SUMMARY:${INTERNAL_PG}-test-framework = "Packagegroup for internal organization"
...
SUMMARY:${INTERNAL_PG}-udev = "Packagegroup for internal organization"
