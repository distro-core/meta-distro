...
# PACKAGES += "${PN}-pattern"
# SUMMARY:${PN}-pattern = "Packagegroup for images"
# DESCRIPTION:${PN}-pattern = "Description"
# FILES:${PN}-pattern = ""
# RDEPENDS:${PN}-pattern = ""
...
"
RDEPENDS:${PN}-systemd:distro-tiny = ""
...
RRECOMMENDS:${PN}-bootloader-none = "initramfs-framework-sota"
...
RDEPENDS:${INTERNAL_PG}-lxc:remove:libc-musl = "lxcfs"
