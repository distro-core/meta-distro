...
REQUIRED_DISTRO_FEATURES:distro-core-gui = "sota usrmerge opengl polkit vulkan wayland x11"
REQUIRED_DISTRO_FEATURES:distro-musl-gui = "sota usrmerge opengl polkit vulkan wayland x11"
...
packagegroup-distro-machine packagegroup-distro-systemd \
packagegroup-distro-core \
packagegroup-distro-core-sdk \
"

DISTRO_IMAGE_INSTALL:distro-core-gui = " \
kernel-initramfs \
ostree-kernel ostree-initramfs ostree-devicetrees \
packagegroup-distro-machine packagegroup-distro-systemd \
packagegroup-distro-core \
...
DISTRO_IMAGE_INSTALL:distro-musl-gui = " \
kernel-initramfs \
ostree-kernel ostree-initramfs ostree-devicetrees \
packagegroup-distro-machine packagegroup-distro-systemd \
packagegroup-distro-core \
