...
# DISTRO_IMAGE_INSTALL:remove:wsl-amd64 = "kernel-initramfs ostree-kernel ostree-initramfs ostree-devicetrees"
# DISTRO_IMAGE_INSTALL:remove:wsl-arm64 = "kernel-initramfs ostree-kernel ostree-initramfs ostree-devicetrees"
